...
export class Translations extends Component {
    ...
    getENGJson = () => {
        axios.get('https://api.forumconcepts.fr/en',)
        .then(res=> {
    ...
    getFRJSON = () => {
        axios.get('https://api.forumconcepts.fr/fr',)
        .then(res=> {
    ...
    saveJSON = () => {
        axios.get('https://api.forumconcepts.fr/eng').then(res=>{ this.saveRes(res) });
    ...
    render() {
        ...
        return(
            <div className="Translations" style={{
                backgroundImage:`url(${wallpaper})`,
                maxWidth:'auto',
                minHeight:'105vh',
                height:'auto',
                ...
                <Grid container justifyContent="center" direction="row">
                    <Grid container justifyContent="center" item xs={4}>
                        <h3>English</h3>
                    <ReactJson src={this.state.english} enableClipboard={false} theme={{
                base00: "transparent",
                base01: "white",
                base02: "#ddd",
                base03: "#444",
                ...
                base0E: "green",
                base0F: "orangered"
            }} iconStyle="square" onEdit={e => { const data = e.updated_src;
                        axios.post("https://api.forumconcepts.fr/translation/update/english", data).then(res => {
                            console.log(data);
                            res.json(data);
                        })
                        .catch(err => console.log(err));
                    ...
                    <Grid container justifyContent="center" item xs={4}>
                        <h3>French</h3>
                        <ReactJson src={this.state.french} enableClipboard={false} theme={{
                                                                                    base00: "transparent",
                                                                                    base01: "white",
                                                                                    base02: "#ddd",
                                                                                    base03: "#444",
                            ...
                            iconStyle="square"onEdit={e => { const data = e.updated_src;
                                axios.post("https://api.forumconcepts.fr/translation/update/french", data).then(res => {
                                    console.log(data);
                                    res.json(data);
                                })
                                .catch(err => console.log(err));
