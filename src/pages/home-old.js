        ...
        <header>
          <div className="container">
            <div className="row">
                ...
                <h1 id="home-page-title"><Trans>{t("riTitle")}</Trans></h1>
             
              <div className="col s1 m1">
              <button id="res-back-btn" onClick={this.onBackClick} style={{ 
                            width: "125px",
                            borderRadius: "3px",
                            letterSpacing: "1.5px",
                            marginTop: "1rem"}}
         ...
         <div id="main-menu-item-blockR" className="container">
          <div className="row">
            <div className="col s12 m4">
              <div> 
              {this.state.resourceOpts === "[T]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TCWCtM]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TC]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CT]" && (
                  <Templates_card />
                )}
                ...
                {this.state.resourceOpts === "[WT]" && (
                 ...
                 {this.state.resourceOpts === "[TCt]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CtT]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[MT]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TM]" && (
                  <Templates_card />
                )}
                ...
                {this.state.resourceOpts === "[TCCt]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TCtC]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CCtT]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CtTC]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CtCT]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TCM]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[CMT]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[TMC]" && (
                  <Templates_card />
                )}
                {this.state.resourceOpts === "[MTC]" && (
                  <Templates_card />
                )}
                ...
                {this.state.resourceOpts === "[WCtT]" && (
                                   ...
                                   {this.state.resourceOpts === "[TMCt]" && (
                                   <Templates_card />
                                   )}
                 {this.state.resourceOpts === "[CtMT]" && (
                                   <Templates_card />
                                   )}
                 {/** 4 tiles options */}
            ...
            <div className="col s12 m4">
              ...
              {this.state.resourceOpts === "[C]" && (
               ...
               {this.state.resourceOpts === "[TC]" && (
                ...
                {this.state.resourceOpts === "[CCt]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[CtC]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[CM]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[MC]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[TCW]" && (
                   <Checklists_card />
                ...
                {this.state.resourceOpts === "[CCtM]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[CMCt]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[MCtC]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[CtMC]" && (
                  <Checklists_card />
                )}
                {this.state.resourceOpts === "[MCCt]" && (
                  <Checklists_card />
                )}
            ...
            <div className="row">
              <div className="col s12 m4">
                ...
                {this.state.resourceOpts === "[CtM]" && (
                      <Contractor_card />
                )}
                {this.state.resourceOpts === "[MCt]" && (
                      <Contractor_card />
                )}
                {this.state.resourceOpts === "[TCCt]" && (
                   <Contractor_card />
                ...
                {this.state.resourceOpts === "[MCCt]" && (
                 ...
                 {this.state.resourceOpts === "[MCtT]" && (
                 <Contractor_card />  
                 )}
                 {this.state.resourceOpts === "[CtTM]" && (
                 <Contractor_card />  
                 )}
                 {this.state.resourceOpts === "[TMCt]" && (
                 <Contractor_card />  
