...
function Resources(props) {
    ...
    function getFiles()  {  
        axios.get("https://api.forumconcepts.fr/api/files/getResources")
            .then(res => {
    ...
    function deleteResources(doc_id, resolve){
        axios.get("https://api.forumconcepts.fr/api/files/deleteResource/"+doc_id)
        .then(res => {
    ...
    return (
        <div className="Resources" style={{backgroundImage:`url(${wallpaper})`,
        height:'100vh',
        marginTop:'0px',
        backgroundSize: 'cover',
        backgroundRepeat: 'no-repeat',}}>
                                        ...
                                        render: rowData => {
                                            return (
                                              <iframe
                                                width="100%"
                                                height="600px"
                                                src={"https://api.forumconcepts.fr/Resources/"+rowData.file_name}
                                                frameborder="0"
                                                allowfullscreen
                                              />
                                            )
