    ...
    render() {
        ...
        return (
            <div className="fileExplr" style={myStyle}>
                ...
                <h1 id="title-pages">
                    <Link to="/dashboard">
                    <svg xmlns="http://www.w3.org/2000/svg" width="392" height="110.327" viewBox="0 0 392 120.327">
                                <text id="Médias" transform="translate(131 93.327)" fill="#ffffff" font-size="80" font-family="Test"><tspan x="0" y="0"><Trans>{t("mediaCard")}</Trans></tspan></text>
                                <g id="media-monitor-screen-Digital_Marketing" data-name="media-monitor-screen-Digital Marketing" transform="translate(-2 -1.999)">
                                  <path id="Path_36" data-name="Path 36" d="M106.809,25.9h-3.678V24.066h1.839a5.516,5.516,0,1,0,0-11.033h-1.839V3.84a1.78,1.78,0,0,0-.754-1.471,1.822,1.822,0,0,0-1.618-.294L77.113,9.356h-12.6a1.839,1.839,0,0,0-1.839,1.839v1.839H59a1.839,1.839,0,0,0-1.839,1.839v7.355A1.839,1.839,0,0,0,59,24.066h3.678V25.9H51.646V9.356a1.839,1.839,0,0,0-1.839-1.839H13.033a1.839,1.839,0,0,0-1.839,1.839V25.9H7.516A5.533,5.533,0,0,0,2,31.421v58.84a5.533,5.533,0,0,0,5.516,5.516H49.808v5.516H38.775a1.839,1.839,0,0,0-1.839,1.839v7.355a1.839,1.839,0,0,0,1.839,1.839H75.55a1.839,1.839,0,0,0,1.839-1.839v-7.355a1.839,1.839,0,0,0-1.839-1.839H64.518V95.777h42.291a5.533,5.533,0,0,0,5.516-5.516V31.421a5.533,5.533,0,0,0-5.516-5.516Zm-3.678-9.194h1.839a1.839,1.839,0,1,1,0,3.678h-1.839Zm-23.9-4.156L99.454,6.322V30.777L79.228,24.544Zm-12.871.478H75.55V24.066H66.356Zm5.24,14.71-1.324,9.194H68.2V27.743ZM60.84,20.388V16.711h1.839v3.678ZM14.871,11.195h33.1V36.937h-33.1Zm58.84,93.777v3.678h-33.1v-3.678Zm-20.226-3.678V95.777H60.84v5.516Zm55.163-11.033a1.839,1.839,0,0,1-1.839,1.839H7.516a1.839,1.839,0,0,1-1.839-1.839V88.422h102.97Zm0-5.516H5.678V31.421a1.839,1.839,0,0,1,1.839-1.839h3.678v9.194a1.839,1.839,0,0,0,1.839,1.839H49.808a1.839,1.839,0,0,0,1.839-1.839V29.582H64.518v9.194a1.839,1.839,0,0,0,1.839,1.839h5.516a1.839,1.839,0,0,0,1.82-1.581l1.618-11.29h1.8l23.646,7.281a1.7,1.7,0,0,0,.533.074,1.866,1.866,0,0,0,1.839-1.839V29.582h3.678a1.839,1.839,0,0,1,1.839,1.839Z" transform="translate(0 0)" fill="#ffffff"/>
                                  <path id="Path_37" data-name="Path 37" d="M7.839,60.1H55.646a1.839,1.839,0,0,0,1.839-1.839V28.839A1.839,1.839,0,0,0,55.646,27H7.839A1.839,1.839,0,0,0,6,28.839v29.42A1.839,1.839,0,0,0,7.839,60.1ZM9.678,56.42V32.128l21.1,12.987a1.839,1.839,0,0,0,1.927,0l21.1-12.987V56.42Zm4.658-25.743H49.15L31.743,41.39Z" transform="translate(3.355 20.97)" fill="#ffffff"/>
                                  <path id="Path_38" data-name="Path 38" d="M37.839,50.743h3.678v5.516A1.839,1.839,0,0,0,43.355,58.1H74.614a1.839,1.839,0,0,0,1.839-1.839V34.194a1.839,1.839,0,0,0-1.839-1.839H72.775V26.839A1.839,1.839,0,0,0,70.936,25h-33.1A1.839,1.839,0,0,0,36,26.839V48.9A1.839,1.839,0,0,0,37.839,50.743ZM72.775,54.42H45.194V36.033H72.775Zm-33.1-25.743H69.1v3.678H43.355a1.839,1.839,0,0,0-1.839,1.839V47.065H39.678Z" transform="translate(28.518 19.292)" fill="#ffffff"/>
                                  <path id="Path_39" data-name="Path 39" d="M43,33h3.678v3.678H43Z" transform="translate(34.389 26.002)" fill="#ffffff"/>
                                  <path id="Path_40" data-name="Path 40" d="M47,33H59.871v3.678H47Z" transform="translate(37.744 26.002)" fill="#ffffff"/>
                                  <path id="Path_41" data-name="Path 41" d="M43,37h7.355v3.678H43Z" transform="translate(34.389 29.357)" fill="#ffffff"/>
                                  <path id="Path_42" data-name="Path 42" d="M49,37h9.194v3.678H49Z" transform="translate(39.422 29.357)" fill="#ffffff"/>
                                  <path id="Path_43" data-name="Path 43" d="M15.872,24.436a1.839,1.839,0,0,0,1.789.081L28.693,19a1.839,1.839,0,0,0,0-3.291L17.661,10.193A1.839,1.839,0,0,0,15,11.839V22.872A1.839,1.839,0,0,0,15.872,24.436Zm2.806-9.622,5.082,2.541L18.678,19.9Z" transform="translate(10.904 6.71)" fill="#ffffff"/>
                                </g>
                            </svg>
                    </Link>
                </h1>     
