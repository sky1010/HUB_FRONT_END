...
class UploadResources extends Component {
    ...
    uploadFile  = (e) => {
        ...
        axios.post('https://api.forumconcepts.fr/uploadResource', Data, config)
          .then(res => {
            console.log(res);
    ...
    render() {
        ...
        return(
            <div className="UploadResources" style={{backgroundImage:`url(${wallpaper})`,
            height:'100vh',
            marginTop:'0px',
            backgroundSize: 'cover',
            backgroundRepeat: 'no-repeat',}}>
                <div className="container">
                    <div className="row">
                        ...
                        <div className="input-field col s6 m6">
                            <Select onChange={ (e) => {this.state.category = e.value}}
                                options={categories}
                                id="cat"
                        ...
                        <div className="input-field col s6 m6">
                            <Select onChange={ (e) => {this.state.client = {"id":e.value, "name": e.label}}}
                        ...
                        <div className="input-field col s6 m6">
                            <input className="custom-file-input" type="file" onChange={this.saveFile}/>
                        </div>
                        <div className="col offset-s10">
                            <button  className="btn btn-large waves-effect waves-dark hoverable white black-text accent-3" onClick={this.uploadFile}>Upload</button>
                        </div>
                    </div>
                </div>
