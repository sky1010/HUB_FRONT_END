...
class Home extends Component {
  ...
  serviceCard = () => {
    ...
    if(this.state.hubOpts?.Service === true || this.state.hubOpts?.All === true){
        return (
          <a target="_blank" href={ServiceLink}>
              <img class="hub-main-button" width="235" height="200"  src={blueCard} />
              <img class="hub-button-text" width="215" height="95" src={hubService}/>
          </a>
        );
      } else return null;
  }
  ...
  contactCard = () => {
    if(this.state.hubOpts?.Contact === true || this.state.hubOpts?.All === true){
      return (
        <a target="_blank" href="https://support.forumconcepts.fr">
            <img class="hub-main-button" width="235" height="200"  src={blueCard} />
            <img class="hub-button-text" width="215" height="95" src={hubContact}/>
        </a>
      );
    } else return null;
  }
  ...
  settingsCard = () => {
    if(this.state.hubOpts?.Settings === true || this.state.hubOpts?.All === true){
      if(localStorage.i18nextLng === "fr"){
        return (
          <Link target="_blank" to="/admin">
              <img class="hub-main-button" width="235" height="200"  src={blueCard} />
              <img class="hub-button-text" width="215" height="95" src={hubParametre}/>
            </Link>
        );
      }
      else {
        return (
          <Link target="_blank" to="/admin">
              <img class="hub-main-button" width="235" height="200"  src={blueCard} />
              <img class="hub-button-text" width="215" height="95" src={hubSettings}/>
            </Link>
        );
      }
    } else return null;
  ...
  reportCard = () => {
    ...
    if(this.state.hubOpts?.Reports === true || this.state.hubOpts?.All === true) {
      if(localStorage.i18nextLng === "fr"){
        return (
          <a target="_blank" href={RepLink}>
                <img class="hub-main-button" width="235" height="200"  src={blueCard} />,
                <img class="hub-button-text" src={hubRapport} width="215" height="95"/>
          </a>
        ...
        return (
          <a target="_blank" href={RepLink}>
                <img class="hub-main-button" width="235" height="200"  src={blueCard} />,
                <img class="hub-button-text" src={hubReports} width="215" height="95"/>
          </a>
        );
      }
    } else return null;
  ...
  resourceCard = () => {
    if(this.state.hubOpts?.Resource === true || this.state.hubOpts?.All === true) {
      if(localStorage.i18nextLng === "fr") {
        return (
          <Link target="_blank" to="/dashboard">
            <img class="hub-main-button" width="235" height="200"  src={blueCard} />
            <img class="hub-button-text" src={hubBibliotheque} width="215" height="95" />
          </Link>
        );
      }
      else {
        return (
          <Link target="_blank" to="/dashboard">
            <img class="hub-main-button" width="235" height="200"  src={blueCard} />
            <img class="hub-button-text" src={hubResource} width="215" height="95" />
          </Link>
        );
      }
    } else return null;
        ...
        <div class="hub-container-right">
          <div class="container-column">
            <div class="welcome-message">
              <h3><Trans>{t("hello")}</Trans> {this.state.user.name}!</h3> 
              <p><Trans>{t("welcomeMessage")}</Trans></p>
            </div>
        </div>
