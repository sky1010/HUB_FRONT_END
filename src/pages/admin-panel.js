...
class AdminPanel extends Component {
    ...
    settingsCard = () => {
      if(localStorage.i18nextLng === "fr"){
        return (
          <img width="215" height="95" src={hubParametre}/>
        );
      }
      else {
        return (
          <img width="215" height="95" src={hubSettings} />
        );
      }
    }
    ...
    getCafmId = (id) => {
      let cat = "CAFM"
      axios.get("https://api.forumconcepts.fr/api/users/userLinks/"+id+"/"+cat)
        .then(res => {{
          if(res.data){
    ...
    getOptsid = (id, category) => {
      ...
      axios.get("https://api.forumconcepts.fr/api/users/getUserOptsbycat/"+id+"/"+category)
        .then(res => {{
          if(res.data) {
    ...
    editPermissionsRI = () => {
      if(this.state.OptionsId === null){
        ...
        axios.post('https://api.forumconcepts.fr/api/users/newOpts/'+this.state.selectedUser+'/'+this.state.optsCat, opts)
          .then(res => {
            console.log(res.data)
          })
          .catch(err => console.log(err));
        ...
        const opts = {code: this.state.resourceOpts}
        axios.put('https://api.forumconcepts.fr/api/users/userOpts/'+this.state.OptionsId+'/'+this.state.selectedUser, opts)
          .then(res => {
            console.log(res.data)
          })
          .catch(err => console.log(err))
    ...
    getUsersNames = () => {
      axios.get("https://api.forumconcepts.fr/api/usersNameList")
      .then(res => {{
        if(res.data){
          //console.log(res.data);
    ...
    deleteUser(user_id,resolve){
      axios.delete("https://api.forumconcepts.fr/api/deleteuser/"+user_id)
      .then(res => {
        console.log(res.data)
        resolve()
        this.getUsers();
    ...
    // @access Admin only
    editUser = (newData) => {
      axios.put("https://api.forumconcepts.fr/api/users/userData/"+this.state.UserSelectedData.id, newData)
      .then(res => {
        console.log(newData) 
        console.log(res.data)
        this.getUsers(); 
    ...
    HubcheckboxChange = e => {
      ...
      if(e.target.checked){
        ...
        let obj = Array.from(this.state.selectedopts).reduce((obj, [key, value]) => {
            obj[key] = value;
            return obj;
          }, {});
          console.log(obj)
      ...
      hubgenCode = () => {
        ...
        axios.put("https://api.forumconcepts.fr/api/updateuser/"+this.state.UserSelectedData._id, hubOpts)
      .then(res => {
        console.log(this.state.hubOpts);
        console.log(res.data);
      })
    ...
    checkboxChange = e => {
      ...
      genCode = () => {
        ...
        axios.put("https://api.forumconcepts.fr/api/updateuser/"+this.state.UserSelectedData._id, resourceOpts)
      .then(res => {
        console.log(this.state.resourceOpts);
        console.log(res.data);
      })
    ...
    getSelectedDetails = () => {
      axios.get("https://api.forumconcepts.fr/api/users/getUser/"+this.state.selectedUser)
          .then(res => {{
            if(res.data){
      ...
      axios.get("https://api.forumconcepts.fr/api/users/getUserOpts/"+this.state.selectedUser+"/"+this.state.optsCat)
        .then(res => {{
          if(res.data){
      ...
      axios.get('https://api.forumconcepts.fr/api/users/usersLinks/'+this.state.selectedUser+'/CAFM')
        .then(res => {{
          if(res.data){
      ...
      axios.get('https://api.forumconcepts.fr/api/users/usersLinks/'+this.state.selectedUser+'/Reports')
      .then(res => {{
        if(res.data){
      ...
      axios.get('https://api.forumconcepts.fr/api/users/usersLinks/'+this.state.selectedUser+'/SSRS')
        .then(res => {{
          if(res.data){
      ...
      axios.get('https://api.forumconcepts.fr/api/users/usersLinks/'+this.state.selectedUser+'/IOT')
      .then(res => {{
        if(res.data){
    ...
    getClientSelectedDetails = () => {
      axios.get("https://api.forumconcepts.fr/api/users/getUsersName/"+this.state.selectedClient)
        .then(res => {
          {
            if(res.data){
    ...
    newUserData = () => {
      let newData = {};
      if(!this.state.name && !this.state.email && !this.state.password && !this.state.lang) {
        newData = {
          client: this.state.client,
        }
      } else if(!this.state.email && !this.state.client && !this.state.password && !this.state.lang){
        newData = {
          name: this.state.name,
        }
      } else if(!this.state.name && !this.state.client && !this.state.password && !this.state.lang) {
        newData = {
          email: this.state.email,
        }
      }else if (!this.state.name && !this.state.email && !this.state.client && !this.state.lang){
        newData = {
          password: this.state.password,
        }
      } else if(!this.state.name && !this.state.client && !this.state.email && !this.state.password){
        newData = {
          code: this.state.lang,
        }
        if(this.state.OptionsId === null) {
          axios.post('https://api.forumconcepts.fr/api/users/newOpts/'+this.state.selectedUser+'/'+this.state.optsCat, newData)
          .then(res => {
            console.log(res.data)
          })
          .catch(err => console.log(err));
        } else {
          axios.put('https://api.forumconcepts.fr/api/users/userOpts/'+this.state.OptionsId+'/'+this.state.selectedUser, newData)
          .then(res => {
            console.log(res.data)
          })
          .catch(err => console.log(err))
    ...
    UpdateLinks = () => {
      ...
      if(this.state.Reports){
        ...
        if(this.state.ReportsId === null) {
          axios.post('https://api.forumconcepts.fr/api/users/addLink'+this.state.selectedUser+'/'+category, newLinks)
          .then(res => console.log(res.data))
          .catch(err => console.log(err));
        } else {
          axios.put('https://api.forumconcepts.fr/api/users/editlinks/'+this.state.ReportsId+'/'+category, newLinks)
          .then(res => console.log(res.data))
          .catch(err => console.log(err));
        }
      } if(this.state.CAFM){
        ...
        if(this.state.CAFMiD === null) {
          ...
          axios.put('https://api.forumconcepts.fr/api/users/editlinks/'+this.state.CAFMiD+'/'+category, newLinks)
          .then(res => console.log(res.data))
          .catch(err => console.log(err));
        }
        ...
        if(this.state.SSRSiD === null) {
          ...
          axios.put('https://api.forumconcepts.fr/api/users/editlinks/'+this.state.SSRSiD+'/'+category, newLinks)
          .then(res => console.log(res.data))
          .catch(err => console.log(err));
        }
      } if(this.state.IOT){
        ...
        if(this.state.IOTiD === null) {
          ...
          axios.put('https://api.forumconcepts.fr/api/users/editlinks/'+this.state.IOTiD+'/'+category, newLinks)
          .then(res => console.log(res.data))
          .catch(err => console.log(err));
        }
      }
    ...
    renderUserList = () => {
      if(this.state.ClientSelectedData){
        ...
        return ( 
          ...
          <Grid item columns={{ xs: 2, s:3, md: 4}} justifyContent="center" alignItems="center">
           <Box sx={{width: 250,
              height: 500,
              position: 'relative',
              top: '-92px',
              ...
              boxShadow: 3,
                ...
                <ul>
                  ...
                  <li id="li-names" key={item._id}>
                    <div className="user-list-item" style={{color: "black"}} onClick={() => this.userSelction(item.id)} ><span>{item.name}</span></div>
                  </li> 
                  ))}
                </ul>
            </Box> 
        ...
        return (
          <Grid container justifyContent="center">
           <Grid item columns={{ xs: 2, s:3, md: 4}}> 
             <button id="translation-btn" onClick={this.translationsTable} style={{ 
               width: "300px",
               borderRadius: "3px",
               letterSpacing: "1.5px",
               marginTop: "1rem"}}
        ...
        return (
          ...
          <Grid item columns={{ xs: 2, s:3, md: 4}} justifyContent="center" alignItems="center">
            ...
            <Box sx={{borderBottom: 1, borderColor: 'divider'}} >
              <TabList onChange={this.tabsChange}
              variant="scrollable"
              scrollButtons="auto">
                ...
                <Tab label={<Trans>{t("resourcesMenuOptsTab")}</Trans>} value="4" />
                    ...
                    <Stack spacing={2}>
                      <div>
                        <input
                          ...
                          />
                        <label htmlFor="name"><Trans>{t("nameInput")}</Trans></label>
                      </div>
                      <div>
                        <input onChange={this.onChange}
                          ...
                          />
                        <label htmlFor="email"><Trans>{t("emailInput")}</Trans></label>
                      </div>
                      <div>
                        ...
                        <label htmlFor="client"><Trans>{t("clientInput")}</Trans></label>
                      </div>
                      <div>
                        <input onChange={this.onChange}
                          ...
                          />
                        <label htmlFor="password"><Trans>{t("passwordInput")}</Trans></label>
                      </div>
                      <div>
                        
                          <Select labelId="lgn-selector" 
                          id="lgn-select"
                          options={lng}
                          placeholder={this.state.LngCode}
                          onChange={ (e) => { this.state.lang = e.value; console.log(this.state.lang)}}/>
                          <label id="lgn-selector"><Trans>{t("languageInput")}</Trans></label>
                      </div>
                      <button id="editUdata-btn-save" onClick={() => (this.newUserData())}
                          className="btn btn-small waves-effect waves-dark hoverable white black-text accent-3"><Trans>{t("save")}</Trans></button>
            ...
            <Box
                ...
                <Stack>
                  <div>
                  <label htmlFor="REPORT"><Trans>{t("reportsLink")}</Trans></label>
                    <input type="text" 
                      id="REPORT"
                      name="Reports"
                  ...
                  <div>
                    <label htmlFor="CAFM"><Trans>{t("managementLink")}</Trans></label>
                    <input type="text" 
                      onChange={this.editlink}
                  ...
                  <div>
                  <label htmlFor="SSRS"><Trans>{t("ssrsLink")}</Trans></label>
                    <input type="text" 
                      onChange={this.editlink}
                  ...
                  <div>
                  <label htmlFor="IOT"><Trans>{t("iotLink")}</Trans></label>
                    <input type="text" 
                      onChange={this.editlink}
                  ...
                  <button id="editUlinks-btn-save" onClick={() => (this.UpdateLinks())}
                  className="btn btn-small waves-effect waves-dark hoverable white black-text accent-3"><Trans>{t("save")}</Trans></button>
            ...
            <TabPanel value="3">
              ...
              autoComplete="off">
                <FormGroup onChange={this.HubcheckboxChange}>
                    <Stack>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={e => {this.setState({ isTrue: e.target.checked }); console.log(this.state.isTrue)}} name="All" value="{All: true}"/>} label={<Trans>{t("SelectAllLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeService} checked={this.IsCheckedService()} name="Service"/>} label={<Trans>{t("ServiceLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChange} checked={this.IsCheckedCAFM()} name="CAFM"/>} label={<Trans>{t("CAFMLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeREP} checked={this.IsCheckedRep()} name="Reports"/>} label={<Trans>{t("ReportsLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeIOT}checked={this.IsCheckedIOT()} name="IOT" value="K"/>} label={<Trans>{t("IOTLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeRES} checked={this.IsCheckedRes()} name="Resource" value="B" />} label={<Trans>{t("ResourcesLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeSc} checked={this.IsCheckedSc()} name="Settings" value="Sc"/>} label={<Trans>{t("SettingsLabel")}</Trans>} />
                      </div>
                      <div>
                        ...
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeHD} checked={this.IsCheckedHD()} name="Contact" value="H"/>} label={<Trans>{t("SupportLabel")}</Trans>} />
                      </div>
                      <button id="opts-btn-save" onClick={() => {this.editPermissionsHUB()}}
                  className="btn btn-small waves-effect waves-dark hoverable white black-text accent-3"><Trans>{t("save")}</Trans></button>
            ...
            <TabPanel value="4">
              ...
              >
                  <FormGroup onChange={this.checkboxChange} >
                    <Stack>
                      <div>
                      <FormControlLabel control={<Checkbox onChange={e => {this.setState({ isTrue: e.target.checked }); console.log(this.state.isTrue)}} name="All" value="TCWCtM"/>} label={<Trans>{t("SelectAllLabel")}</Trans>}/>
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChange} checked={this.IsCheckedCAFM()} name="Templates" value="T"/>} label={<Trans>{t("TemplatesLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox  onChange={this.ChckhandleChangeREP} checked={this.IsCheckedRep()} name="Checklist" value="C"/>} label={<Trans>{t("ChecklistsLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox  onChange={this.ChckhandleChangeIOT}checked={this.IsCheckedIOT()} name="Workflows" value="W" />}  label={<Trans>{t("WorkflowsLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox onChange={this.ChckhandleChangeRES} checked={this.IsCheckedRes()} name="Contractor"   value="Ct" />} label={<Trans>{t("ContractorLabel")}</Trans>} />
                      </div>
                      <div>
                        <FormControlLabel control={<Checkbox  onChange={this.ChckhandleChangeSc} checked={this.IsCheckedSc()} name="Medias" value="M" />}  label={<Trans>{t("MediaLabel")}</Trans>} />
                      </div>
                      <button id="opts-btn-save" onClick={() => {this.editPermissionsRI()}}
                  className="btn btn-small waves-effect waves-dark hoverable white black-text accent-3"><Trans>{t("save")}</Trans></button>
                    </Stack>
    ...
    render() {
        ...
        return(
            <div className="AdminPanel">
                    ...
                    <div className="container">
                        <div className="row">
                            <div id="back-btn" className="col offset-s1 offset-m1">
                                <button onClick={this.onBackClick} style={{ 
                            width: "125px",
                            borderRadius: "3px",
                            letterSpacing: "1.5px",
                            marginTop: "1rem"}}
                ...
                <Box sx={{ flexGrow: 1}}>
                  <Grid container justifyContent="center" alignItems="center" id="admin-btns" direction="row" spacing={1}>
                      <Grid item columns={{ xs: 2, s:3, md: 4}}>
                        <button onClick={this.onRegClick} style={{ 
                              width: "300px",
                              borderRadius: "3px",
                              letterSpacing: "1.5px",
                              marginTop: "1rem"}}
                      ...
                      <Grid item columns={{ xs: 2, s: 3, md: 4}}>
                        <button  onClick={this.onUploadClick} style={{ 
                              width: "300px",
                              borderRadius: "3px",
                              letterSpacing: "1.5px",
                              marginTop: "1rem"}}
                      ...
                      <Grid item columns={{ xs: 2, s:3, md: 4}}>
                        <button  onClick={this.availRes} style={{ 
                              width: "300px",
                              borderRadius: "3px",
                              letterSpacing: "1.5px",
                              marginTop: "1rem"}}
                      ...
                      <Grid item columns={{ xs: 2, s: 3, md: 4}}>
                        <button  onClick={this.onViewUp} style={{ 
                              width: "300px",
                              borderRadius: "3px",
                              letterSpacing: "1.5px",
                              marginTop: "1rem"}}
                  ...
                  <Grid container justifyContent="center" alignItems="center" spacing={1}>
                    <Grid item columns={{ xs: 2, s:3, md: 4}} >
                      <Box sx={{width: 250,
                            ...
                            <button onClick={this.onNewClientClick} style={{ 
                            width: "150px",
                            height: "30px",
                            left: "70px",
                            borderRadius: "3px",
                        ...
                        <ul id="client-list">
                          ...
                          <li id="li-client" key={item.id}>
                            <div className="client-list-item" style={{color: "black"}} onClick={() => this.clientSelection(item.id)} ><span>{item.name}</span></div>
                          </li> 
                          ))}
                        </ul>       
                      </Box> 
