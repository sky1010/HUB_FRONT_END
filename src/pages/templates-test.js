...
function Templates(props) {
    ...
    useEffect(() => {
        setToken(getToken());
        axios.get("http://localhost:3512/Resources/filemaptest.json")
        .then(res => {
    ...
    const testData = async (id) => {
        try {
            const response = await axios.get("https://api.forumconcepts.fr/api/users/getUser/"+id);
    ...
    function getUserUploads(client) {
        if(client) {
            ...
            axios.get("https://api.forumconcepts.fr/api/uploads/getUserUploads/"+client+"/"+category)
                .then(res => {
    ...
    function getFiles(client) {
        if(client) {
            let category = "Templates";
            axios.get("https://api.forumconcepts.fr/api/files/getResources/"+client+"/"+category)
                .then(res => {
    ...
    const useCustomFileMap = () => {
        ...
        const moveFiles = useCallback((files, source, destination) => {
            setFileMap((currentFileMap) => {
                ...
                axios.post('http://localhost:3512/filemap', data, config)
                    .then(res => {
                        console.log(res);
                    })
                    .catch(err => console.log(err))
   ...
   const useFiles = (fileMap, currentFolderId) => {
    ...
    const useFileActionHandler = (setCurrentFolderId, moveFiles, createFolder) => {
    ...
    const { fileMap, currentFolderId, setCurrentFolderId, moveFiles, createFolder } = useCustomFileMap();
    ...
    function DelayedMFB() {
            ...
            return (
                <FullFileBrowser files={files} folderChain={folderChain} fileActions={fileActions} onFileAction={handleFileAction}  iconComponent={ChonkyIconFA}>
                    <FileToolbar />
                    <FileList />
                    <FileContextMenu />
                </FullFileBrowser>
    ...
    return (
        <div className="Templates">
            <header>
                    <h1 id="title-pages">
                        <Link to="/dashboard">
                        <svg xmlns="http://www.w3.org/2000/svg" width="588.248" height="102.073" viewBox="0 0 588.248 102.073">
                              <text id="Fichier_Import" data-name="Fichier Import" transform="translate(95 79.964)" fill="#707070" font-size="80" font-family="HelveticaNeue, Helvetica Neue"><tspan x="0" y="0"><Trans>{t("templatesCard")}</Trans></tspan></text>
                              <path id="Path_1" data-name="Path 1" d="M165.9,43.614l-.074-.011-.067-.008c-.03,0-.06,0-.09,0l-.039,0H109.592l-.039,0c-.03,0-.06,0-.09,0l-.069.008a1.5,1.5,0,0,0-1.29,1.315c0,.018,0,.036,0,.055s0,.065,0,.1c0,.006,0,.011,0,.017.066,26.174-.2,25.831.249,26.507a1.508,1.508,0,0,0,1.249.672h56.051a1.5,1.5,0,0,0,1.481-1.481c0-.005,0-.011,0-.016V45.085c0-.005,0-.011,0-.016a1.5,1.5,0,0,0-1.226-1.456Zm-7.133,2.969-21.157,9.7-21.157-9.7Zm-47.677.836,22.927,10.507L111.09,68.433Zm5.364,21.85,21.157-9.7,21.157,9.7Zm47.678-.836L141.2,57.926l22.927-10.507Z" transform="translate(-98.193 -34.898)" fill="#575676"/>
                              <path id="Path_2" data-name="Path 2" d="M132.762,0H62.986A4.491,4.491,0,0,0,58.5,4.486V30.162a1.5,1.5,0,1,0,2.99,0V4.486a1.5,1.5,0,0,1,1.5-1.5h69.776a1.5,1.5,0,0,1,1.5,1.5v93.1a1.5,1.5,0,0,1-1.5,1.5H62.986a1.5,1.5,0,0,1-1.5-1.5V36.143a1.5,1.5,0,1,0-2.99,0V97.587a4.491,4.491,0,0,0,4.486,4.486h69.776a4.491,4.491,0,0,0,4.486-4.486V4.486A4.491,4.491,0,0,0,132.762,0Z" transform="translate(-58.5)" fill="#575676"/>
                              <path id="Path_3" data-name="Path 3" d="M108.167,237.917a1.5,1.5,0,0,0,1.5,1.5h21.7a1.5,1.5,0,0,0,1.5-1.5V221.45a1.5,1.5,0,0,0-1.5-1.5h-21.7a1.5,1.5,0,0,0-1.5,1.5Zm2.995-14.97h18.707V236.42H111.162Z" transform="translate(-98.265 -176.051)" fill="#575676"/>
                              <path id="Path_4" data-name="Path 4" d="M305.525,219.953H284.16a1.5,1.5,0,1,0,0,2.995h21.365a1.5,1.5,0,1,0,0-2.995Z" transform="translate(-237.922 -176.051)" fill="#575676"/>
                              <path id="Path_5" data-name="Path 5" d="M305.525,261.191H284.16a1.5,1.5,0,1,0,0,2.995h21.365a1.5,1.5,0,1,0,0-2.995Z" transform="translate(-237.922 -209.055)" fill="#575676"/>
                              <path id="Path_6" data-name="Path 6" d="M305.525,302.43H284.16a1.5,1.5,0,1,0,0,2.995h21.365a1.5,1.5,0,1,0,0-2.995Z" transform="translate(-237.922 -242.061)" fill="#575676"/>
                              <path id="Path_7" data-name="Path 7" d="M304.173,366.785h-21.7a1.5,1.5,0,0,0-1.5,1.5v16.467a1.5,1.5,0,0,0,1.5,1.5h21.7a1.5,1.5,0,0,0,1.5-1.5V368.282A1.5,1.5,0,0,0,304.173,366.785Zm-1.5,16.467H283.969V369.78h18.707Z" transform="translate(-236.57 -293.567)" fill="#575676"/>
                              <path id="Path_8" data-name="Path 8" d="M109.664,369.78h21.365a1.5,1.5,0,1,0,0-2.995H109.664a1.5,1.5,0,1,0,0,2.995Z" transform="translate(-98.265 -293.567)" fill="#575676"/>
                              <path id="Path_9" data-name="Path 9" d="M109.664,411.018h21.365a1.5,1.5,0,1,0,0-2.995H109.664a1.5,1.5,0,1,0,0,2.995Z" transform="translate(-98.265 -326.572)" fill="#575676"/>
                              <path id="Path_10" data-name="Path 10" d="M109.664,452.257h21.365a1.5,1.5,0,1,0,0-2.995H109.664a1.5,1.5,0,1,0,0,2.995Z" transform="translate(-98.265 -359.577)" fill="#575676"/>
                            </svg>
                        </Link>
                    </h1>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col offset-s7 offset-m7">
                            <button id="user-btn-upload" onClick={onUploadClick} style={{ 
                                width: "300px",
                                borderRadius: "3px",
                                letterSpacing: "1.5px",
                                marginTop: "1rem"}}
