      ...
      <div className="Login" style={myStyle}>
        <div className="container">
          <div class="button-container">
            <Link
              to="/contractor"
              className="col s1 m1 offset-s1 offset-m10"
              id="cont-pub-btn"
            >
              <svg
              ...
              >
                ...
                >
                  <path
                    id="Path_44"
                    data-name="Path 44"
                    d="M25.848,24H24.386a1.462,1.462,0,0,1-2.924,0H20a2.924,2.924,0,0,0,5.848,0Z"
                    transform="translate(-4.036 -5.919)"
                    fill="#575676"
                  />
                  <rect
                    id="Rectangle_14"
          ...
          <div class="login-container">
            ...
            <form noValidate onSubmit={this.onSubmit} id="form-lgn">
              <div className="input-field col s12 m6">
                ...
                <span className="red-text">{errors.emailOrUsername}</span>
              </div>
              <div className="input-field col s12 m6">
                <input
                  onChange={this.onChange}
